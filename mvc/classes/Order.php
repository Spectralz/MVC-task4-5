...
class Order
{
    ...
    public static function showAllOrders(){
        return $sql = "SELECT u.name as user_name, p.name as product_name, p.price, o.date , orders_list.product_id , orders_list.order_id, orders_list.quantity FROM orders_list
